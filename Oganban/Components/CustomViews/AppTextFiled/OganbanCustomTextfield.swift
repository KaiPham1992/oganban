...
@IBDesignable class OganbanCustomTextfield: UIView{
    ...
    private func setConstraint(){
        ...
        ivRightIcon.heightAnchor.constraint(equalToConstant: 100).isActive = true
        ivRightIcon.widthAnchor.constraint(equalToConstant: 100).isActive = true
    ...
    func showRightIcon(isHidden: Bool = false, sỉze: CGSize = CGSize(width: 100, height: 100), icon: UIImage? = nil, paddingRight: CGFloat = 0) {
