...
class TabbarViewController: UITabBarController {
    ...
    func setUpTabbar() {
        ...
        let vcHome = HomeRouter.createModule()// PostStepTwoRouter.createModule(param: PostRecordParam(categoryId: "1", name: "", imgSrc: [], quantity: "1", expireDate: "", aboutRecord: "1"), isService: true) //
