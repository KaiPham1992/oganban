...
// MARK: table
extension MySellExpiredDetailViewController: UITableViewDelegate, UITableViewDataSource {
    func configureTable() {
        ...
        tbDetail.registerXibFile(MySellExpiredDetailImageCell.self)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case OrderDetailInfoType.infoProduct.rawValue:
            let cell = tbDetail.dequeueTableCell(MySellExpiredDetailImageCell.self)
...
// MARK: helper
extension MySellExpiredDetailViewController {
